...
public class PositionWithDirection extends FragmentActivity implements GooglePlayServicesClient.ConnectionCallbacks,
GooglePlayServicesClient.OnConnectionFailedListener, LocationListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		id=settings.getString("app_id","");
		nearest_id = Integer.valueOf(id);
		...
		if (isMapAvailable())
		{
						...
						if(draw==false)
						{
							if(nearest_id!=-1)
							{
								try
								{
							        ...
							        String str_dest = "destination="+lati+","+longi; 
							        // Sensor enabled
	        ...
	        googleMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
				...
				public void onInfoWindowClick(Marker marker) {
					...
					Intent intent=new Intent(PositionWithDirection.this,Info.class);
					SharedPreferences settings= getSharedPreferences("myprefs", 0);
	...
	public void onConnected(Bundle arg0) {
		...
		{  	
			...
			else
			{
				...
				LatLng loc2=new LatLng(lati,longi);
				Location.distanceBetween(lat1,lon1,lati, longi, results);
			    distance=results[0]/1000;
       		    m2 =googleMap.addMarker(new MarkerOptions().position(loc2).title(name+"\nDistance : "+distance+"km").snippet("Click to see detail"));
