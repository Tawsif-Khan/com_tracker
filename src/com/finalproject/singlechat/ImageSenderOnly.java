...
public class ImageSenderOnly {

	public ImageContentOnly createContent(String title, String msg,
		...
		ImageContentOnly content = new ImageContentOnly();
	...
	public void send(final ImageContentOnly content) {
