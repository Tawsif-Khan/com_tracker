...
public class GCMOnlyOneMessageSender {

	public ContentForOne createContent(String title, String msg,
		...
		ContentForOne content = new ContentForOne();
	...
	public void send(final ContentForOne content) {
